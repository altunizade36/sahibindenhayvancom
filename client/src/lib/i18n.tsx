...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    "home.search.placeholder": "Ara... (örneğin: Golden Retriever)",
    "home.categories": "Kategoriler",
    "home.featured": "Öne Çıkan İlanlar",
    "home.recent": "Son Eklenen İlanlar",
    ...
    "listing.health": "Sağlık Durumu",
    "listing.vaccinated": "Aşılanmış",
    "listing.neutered": "Kısır",
    "listing.pedigree": "Soy Kağıdı",
    "listing.description": "Açıklama",
    "listing.contact": "İletişim",
    "listing.sendMessage": "Mesaj Gönder",
    "listing.makeOffer": "Teklif Ver",
    "listing.addFavorite": "Favorilere Ekle",
    "listing.removeFavorite": "Favorilerden Çıkar",
    ...
    "listing.priceComparison": "Fiyat Karşılaştırması",
    ...
    "seller.level.bronze": "Bronz Satıcı",
    "seller.level.silver": "Gümüş Satıcı",
    "seller.level.gold": "Altın Satıcı",
    "seller.level.platinum": "Platin Satıcı",
    "seller.level.diamond": "Elmas Satıcı",
    
    "pwa.install": "Uygulamayı Yükle",
    "pwa.installPrompt": "Daha iyi deneyim için uygulamayı yükleyin",
    
    "offline.title": "Çevrimdışı",
    "offline.message": "İnternet bağlantınız yok",
