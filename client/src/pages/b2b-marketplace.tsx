    ...
    <div className="container mx-auto py-6 px-4 max-w-7xl">
      <div className="mb-6">
        ...
        <Alert className="bg-yellow-50 border-yellow-200 dark:bg-yellow-950/20 dark:border-yellow-800">
          ...
          <AlertDescription className="text-sm"> Toptan satıcı olarak ürün sunmak için <strong>"Toptan İlan Ver"</strong> butonuna tıklayarak kendi ilanınızı oluşturabilirsiniz.
          </AlertDescription>
        </Alert>
      </div>
