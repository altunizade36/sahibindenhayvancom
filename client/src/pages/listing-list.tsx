...
export default function ListingList() {
  ...
  const clearAll = () => {
    ...
    setFilters({});
    setCurrentPage(1);
    // Kategori filtresini temizlemek için URL'i güncelle (Wouter setLocation kullan)
    setLocation("/ilanlar");
  };

  const hasActiveFilters = activeSearch || urlCategoryId || Object.keys(filters).length > 0;
