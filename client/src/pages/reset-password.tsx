        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className="flex justify-center mb-4">
              <div className="relative p-4 rounded-full bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20">
                <GiUnicorn className="w-16 h-16 text-transparent bg-gradient-to-br from-red-600 to-orange-600 bg-clip-text" style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }} data-testid="icon-logo" />
              </div>
            </div>
            <CardTitle className="text-2xl text-destructive font-bold" data-testid="text-error">
              Geçersiz Link
            </CardTitle>
            <CardDescription className="text-base mt-2" data-testid="text-error-description">
